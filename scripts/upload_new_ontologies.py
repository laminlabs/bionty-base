...
def _upload_ontology_artifacts(
    ...
    """Uploads all source file artifacts to the specified instance.
    ...
    with ln.Session() as ss:
        transform = ln.select(
            ln.Transform, name="Bionty source artifacts"
        ).one_or_none()

        if transform is None:
            transform = ln.add(ln.Transform(name="Bionty source artifacts"))
